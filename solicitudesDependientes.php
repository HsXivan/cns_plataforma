 ...
 * Time: 09:24 PM
 */
$solicitudesPendientes = solicitudesDeEstudiantes($email);
?>
<!-- Intro -->
<div class="container">
...
<div class="row " style="margin-top: 7em;">
    ...
    <div class="row">        
        <div class="col-lg-12">
            <div class="view">
                <h4 class="flex-center request font-weight-bold pl-3" style="color: darkgrey;">Solicitudes pendientes</h4>
                ...
                while ($solicitud = mysqli_fetch_assoc($solicitudesPendientes)) {
                    ...
                    <tr id="<?php echo "fila".$contador;?>">
                        ...
                        <td>
                            ...
                            <a class="mr-2"  href="principal.php?option=15&id=<?php echo codifica($solicitud['correo']);?>&tipo=3" ><i class="fas fa-eye grey-text"></i></a>
                        </td>
                    </tr>
                    <?php
                    $contador++;
...
<script>
    function aceptarAlumno(correo, contador) {
        ...
        $.get("lib/solicitudes.php", {tipo: 1, email:correo, bnd:1, index: contador},function(data){
