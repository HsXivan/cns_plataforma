...
//funcion generar cadena para capcha
...
$fonts=['./acme.ttf', './ubuntu.ttf','./excocet.ttf','./13ghosts.ttf'];

$string_length = 6;
$captcha_string = generate_string($permitted_chars, $string_length);
$_SESSION['captcha_text'] = $captcha_string; ///guardar en sesion el capcha!!
