 ...
 * Time: 09:24 PM
 */
$dependientesActivos = investigadoresActivos();
?>
<!-- Intro -->
<div class="container">
    ...
    <div class="row" >        
        <div class="col-lg-12 ">
            <div class="view">
                <h4 class="flex-center request font-weight-bold pl-3" style="color: darkgrey;">Profesores-Investigadores aprobados en la plataforma</h4>
                            ...
                            <table class="table">
                                ...
                                while ($estudiante = mysqli_fetch_assoc($dependientesActivos)) {
                                    ...
                                    <tr id="<?php echo "fila".$contador;?>">
                                        ...
                                        <td><a class="mr-2"  href="principal.php?option=16&id=<?php echo codifica($estudiante['correo']);?>&tipo=2" ><i class="fas fa-eye grey-text"></i></a></td>
                                    </tr>
                                    <?php
                                    $contador++;
                                }
