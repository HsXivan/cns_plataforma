 ...
 * Time: 09:24 PM
 */
$dependientesActivos = profesionalesActivos();
?>
<!-- Intro -->
...
<div class="container">
    ...
    <div class="row">        
        <div class="col-sm-12">
            <div class="view">
                <h4 class="flex-center request font-weight-bold pl-3" style="color: darkgrey;">Profesionales aprobados en la plataforma</h4>
            ...
            <table class="table">
                ...
                while ($estudiante = mysqli_fetch_assoc($dependientesActivos)) {
                    ...
                    <tr id="<?php echo "fila".$contador;?>">
                        ...
                        <td>
                            <!--a class="mr-2" onclick="verProfesional('<?php //echo codifica($estudiante['correo']);?>' , '<?php //echo "fila".$contador;?>')"><i class="fas fa-eye grey-text"></i></a-->
                            <a class="mr-2"  href="principal.php?option=15&id=<?php echo codifica($estudiante['correo']);?>&tipo=4" ><i class="fas fa-eye grey-text"></i></a>
                        </td>
...
<script>
    function verProfesional(correo,contador) {
